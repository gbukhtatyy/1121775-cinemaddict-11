...
const createFilmCardShortTemplate = () => {
    return (
        `<article class="film-card">
...
for (let i = 0; i < FILM_EXTRA_COUNT; i++) {
    render(filmsRatedContentElement, createFilmCardShortTemplate(), `beforeend`);
}
...
for (let i = 0; i < FILM_EXTRA_COUNT; i++) {
    render(filmsCommentedContentElement, createFilmCardShortTemplate(), `beforeend`);
}
